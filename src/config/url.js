...
export const sendrequest = getEndpoint("user/sendrequest");
...
export const actionOnFriendRequesturl = getEndpoint(
  "user/actionOnFriendRequest"
);
export const getmyfriendsurl = getEndpoint("user/getuserfriends");
