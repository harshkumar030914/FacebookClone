  ...
  return (
    <>
      <View style={styles.container}>
          ...
          <View style={myStyles.row2}>
            <View>
              <Image
                ...
                style={myStyles.post_user}
              />
            </View>
            <View
              style={[
                [myStyles.coulmn, myStyles.hr_center, { paddingHorizontal: 5 }],
              ]}
            >
              <View>
                <Text style={styles.post_name}>
                  {user_name}
                  <Text style={styles.text2}>{" with his  "}</Text>
                  {"Tomadachi"}
                </Text>
              </View>
              <View style={[myStyles.row2, myStyles.vr_center]}>
                ...
                <Image
                  ...
                  style={{
                    height: 9,
                    width: 9,
                    tintColor: Colors.placeholder_txt,
                  }}
                />
              </View>
            </View>
        ...
        <View style={[myStyles.coulmn2, myStyles.padding_10]}>
          <Text style={[styles.details, { color: Colors.black }]}>
            {"Good Show....!! ❤️ 😊"}
          </Text>
        </View>
